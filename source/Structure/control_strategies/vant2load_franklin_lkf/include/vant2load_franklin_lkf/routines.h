...
public:
  ...
  static Eigen::MatrixXd generate_AerodynDisturbances(double xdot, double ydot, double zdot, double phi, double theta,
                                                      double psi, Eigen::MatrixXd wind);
  static Eigen::MatrixXd generate_Wind(int k, double Ts, int which_wind);
  ...
  static void generate_Measurement_truncated(int k, double Ts, simulator_msgs::Sensor mainbody,
